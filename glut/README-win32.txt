...
VERSION/INFO:
    ...
    This is GLUT for Win32 version 3.7.5 as of Oct 4th 2001.
...
CHANGES/FIXES:
    ...
    x  Fixed bug in getVisualInfoFromString(): visuals not reloaded on 
       ...
       Wimmer [wimmer@cg.tuwien.ac.at] for pointing this out & providing 
       the fix.
    ...
    x  Fixed bug in XGetVisualInfo(): pixelformats enumerated incorrectly.
       ...
       Thanks to Michael Wimmer [wimmer@cg.tuwien.ac.at] for pointing this 
       out & providing the fix.
    ...
    x  Fixed bug in glXGetConfig(): pixelformats enumerated incorrectly.  The
       ...
       to Michael Wimmer [wimmer@cg.tuwien.ac.at] for pointing this out & 
       providing the fix.
    ...
    x  Fixed malloc(0) bug in Win32 version of XGetVisualInfo.  Thanks 
       to Kekoa Proudfoot [kekoa@Graphics.Stanford.EDU] for bringing 
    ...
    x  Fixed several compilation problems & corrupt files.  Thanks to 
       Alexander Stohr [alexs@freepage.de] for bringing these to my 
       attention and providing detailed fixes.

    (Dec 6, '00)
    x  Fixed compiler support for lcc.  Thanks to Gordon 
       [gdw33@student.canterbury.ac.nz] for bringing this to my 
       attention and debugging fixes.

    (Nov 8, '00)
    x  Fixed submenu problem (sometimes the menu callback was not 
       called for valid items).  Thanks to Michael Keeley 
       [mkeeley@onetel.net.uk]

    (Oct 16, '00)
    x  Corrected corrupt duck.iv file.  Thanks to Jon Willeke 
       [willeke@intersys.com] for finding this problem.
